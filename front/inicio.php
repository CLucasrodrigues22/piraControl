        ...
        <div class="col-md-6 col-lg-3 d-flex">
          <div class="card border-0 bg-primary text-white text-center mb-grid w-100">
            <div class="d-flex flex-row align-items-center h-100">
              ...
              <div class="card-body">
                <div class="card-info-title"><h4>Produtos</h4><span>(Total)</span></div>
        ...
        <div class="col-md-6 col-lg-3 d-flex">
          <div class="card border-0 bg-success text-white text-center mb-grid w-100">
            <div class="d-flex flex-row align-items-center h-100">
              ...
              <div class="card-body">
                <div class="card-info-title"><h4>Entrada</h4><span>(Total)</span></div>
                <h3 class="card-title mb-0">
                  1,258
                </h3>
              </div>
        ...
        <div class="col-md-6 col-lg-3 d-flex">
          <div class="card border-0 bg-success text-white text-center mb-grid w-100">
            <div class="d-flex flex-row align-items-center h-100">
              ...
              <div class="card-body">
                <div class="card-info-title"><h4>Saída</h4><span>(Total)</span></div>
                <h3 class="card-title mb-0">
                  1,258
                </h3>
              </div>
